...
<div class="ct_background">
    <img class="img_background" src="public/images/background_anime.svg">
    <div class="ct_voyager">
        ...
        <button class="button-bird">
            <p class="button-bird__text"><i class="fas fa-crow"></i>&nbsp; <span>Commençons le voyager ! </span></p>
...
<div class="ct_mise_en_avant">
    <h1>Nos meilleurs plans !</h1>
</div>
<script>
